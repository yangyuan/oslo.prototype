...
Prototype Specific Commandments
---------------------------
...
infrastructure in OpenStack Prototype, please read ``prototype/tests/unit/README.rst``.
...
You should wind up with a PDF - Prototype.pdf.
